...
public class Task_Details {
    ...
    public Task_Details(int task_id, String title, String status, String start_date, String end_date, String background_color, int username_id, ArrayList<String> TaskItems, JSONObject TaskComments, ArrayList<String> TaskCollaborators) {
