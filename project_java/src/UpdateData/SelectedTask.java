...
public class SelectedTask {
    ...
    public SelectedTask(int task_id, String title, String status, String start_date, String end_date, String background_color, int username_id,JSONArray TaskItems, JSONObject TaskComments, JSONArray TaskCollaborators) {
